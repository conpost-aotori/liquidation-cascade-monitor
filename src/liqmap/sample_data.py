...
def sample_map() -> LiquidationMap:
    ...
    return LiquidationMap(
        ...
        bias_state="静観",
        bias_side="long",
        bias_label="中立〜やや下値リスク優勢",
        bias_components={"funding": -10.0, "oi": 0.0, "skew": -8.0, "smart": 0.0},
        bias_available={"funding": True, "oi": False, "skew": True, "smart": False},
        bias_gate={"open": False, "trigger_px": None, "dist": None, "notional": 0},
    )
