...
def sample_map() -> LiquidationMap:
    ...
    return LiquidationMap(
        ...
        bias_state="監視",
        bias_side="long",
        bias_label="ロング過熱・下落カスケード警戒",
        bias_components={"funding": -28.0, "oi": -16.0, "skew": -8.0, "smart": -6.0},
        bias_available={"funding": True, "oi": True, "skew": True, "smart": True},
        bias_gate={"open": True, "trigger_px": 72000, "dist": 0.019, "notional": 345e6},
    )
